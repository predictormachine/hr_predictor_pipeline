    ...
    for day in sched.get("dates",[]):
        for g in day.get("games",[]):
            ...
            for side in ("away","home"):
                ...
                confirmed = pits[0] if pits else None
                confirmed_name = players.get(f"ID{confirmed}",{}).get("person",{}).get("fullName")
